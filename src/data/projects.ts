...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: 'Mixed Use',
    location: 'Chicago, IL',
    address: '401 W. Ontario Street, Chicago, IL 60654',
    units: 57,
    sqft: '48,328',
    floors: 4,
    description: 'Adaptive reuse of the historic 1905 S. Birkenstein & Sons headquarters into 57 loft residences in River North.',
    image: '/assets/projects/birken-lofts.webp',
    featured: true,
    heroImage: '/assets/projects/birken-lofts/hero.webp',
    gallery: [
      '/assets/projects/birken-lofts/gallery-1.webp',
      '/assets/projects/birken-lofts/gallery-3.webp',
      '/assets/projects/birken-lofts/gallery-9.webp',
      '/assets/projects/birken-lofts/gallery-5.webp',
      '/assets/projects/birken-lofts/gallery-7.webp',
    ],
    yearBuilt: 1905,
    historicDesignation: 'Adaptive reuse of the historic 1905 S. Birkenstein & Sons Company headquarters',
    fullDescription: [
      'Located in Chicago\'s River North neighborhood, Birken Lofts is an adaptive reuse project transforming the historic S. Birkenstein & Sons Company headquarters into a 57-unit residential community. Originally built in 1905, the heavy timber loft building is defined by its red brick façade, arched windows, and exposed timber structure, preserving an important piece of Chicago\'s industrial heritage.',
      'The redevelopment will introduce a mix of studio, one-bedroom, and two-bedroom residences ranging from 564 to 819 square feet, while maintaining the building\'s original character through preserved masonry walls, exposed timber beams, and historic window openings.',
      'Residents will enjoy contemporary finishes and amenities, including new windows, updated kitchens, in-unit laundry, HVAC systems, gigabit internet, a fitness center, co-working space, resident lounge, TV lounge, and bicycle storage.',
    ],
    apartmentAmenities: [
      'New Windows', 'Updated Kitchens', 'In-Unit Laundry', 'HVAC Systems',
      'Gigabit Internet', 'Wood Plank Flooring', 'Exposed Heavy Timber', 'Historic Brick Walls',
      'Historic Arched Window Openings', 'Modern Finishes',
    ],
    communityAmenities: [
      'Fitness Center', 'Co-Working Space', 'Resident Lounge', 'TV Lounge',
      'Bicycle Storage',
    ],
    website: 'BirkenLofts.com',
  },
  {
    id: 'cannery-flats',
    name: 'Cannery Flats',
    ...
    gallery: ['/assets/projects/cannery-flats/gallery-1.webp', '/assets/projects/cannery-flats/gallery-2.webp', '/assets/projects/cannery-flats/gallery-3.webp', '/assets/projects/cannery-flats/gallery-4.webp', '/assets/projects/cannery-flats/gallery-5.webp', '/assets/projects/cannery-flats/gallery-6.webp'],
    fullDescription: [
  ...
  },
  {
    ...
    gallery: ['/assets/projects/1313-west-randolph/gallery-1.webp', '/assets/projects/1313-west-randolph/gallery-2.webp', '/assets/projects/1313-west-randolph/gallery-3.webp', '/assets/projects/1313-west-randolph/gallery-4.webp', '/assets/projects/1313-west-randolph/gallery-5.webp', '/assets/projects/1313-west-randolph/gallery-6.webp'],
    yearBuilt: 1927,
  ...
  },
  {
    ...
    gallery: ['/assets/projects/teton-flats/gallery-1.webp', '/assets/projects/teton-flats/gallery-2.webp', '/assets/projects/teton-flats/gallery-3.webp', '/assets/projects/teton-flats/gallery-4.webp', '/assets/projects/teton-flats/gallery-5.webp', '/assets/projects/teton-flats/gallery-6.webp'],
    fullDescription: [
  ...
  },
  {
    ...
    gallery: ['/assets/projects/box-board-lofts/gallery-1.webp', '/assets/projects/box-board-lofts/gallery-2.webp', '/assets/projects/box-board-lofts/gallery-3.webp', '/assets/projects/box-board-lofts/gallery-4.webp', '/assets/projects/box-board-lofts/gallery-5.webp', '/assets/projects/box-board-lofts/gallery-6.webp'],
    fullDescription: [
  ...
  },
  {
    ...
    gallery: ['/assets/projects/volaris-lansing/gallery-1.webp', '/assets/projects/volaris-lansing/gallery-2.webp', '/assets/projects/volaris-lansing/gallery-3.webp', '/assets/projects/volaris-lansing/gallery-4.webp', '/assets/projects/volaris-lansing/gallery-5.webp', '/assets/projects/volaris-lansing/gallery-6.webp'],
    fullDescription: [
  ...
  },
  {
    ...
    gallery: ['/assets/projects/101-west/gallery-1.webp', '/assets/projects/101-west/gallery-2.webp', '/assets/projects/101-west/gallery-3.webp', '/assets/projects/101-west/gallery-4.webp', '/assets/projects/101-west/gallery-5.webp', '/assets/projects/101-west/gallery-6.webp'],
    fullDescription: [
  ...
  },
  {
    ...
    gallery: ['/assets/projects/851-west-grand/gallery-1.webp', '/assets/projects/851-west-grand/gallery-2.webp', '/assets/projects/851-west-grand/gallery-3.webp', '/assets/projects/851-west-grand/gallery-4.webp', '/assets/projects/851-west-grand/gallery-5.webp', '/assets/projects/851-west-grand/gallery-6.webp'],
    fullDescription: [
