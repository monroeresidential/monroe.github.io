      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/portfolio"
              className="px-8 py-3 bg-monroe-accent text-white text-sm font-medium tracking-wider uppercase hover:bg-monroe-accent/90 transition-colors duration-300"
            >
              View Portfolio
            </Link>
            <Link
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-8 py-3 bg-monroe-accent text-white text-sm font-medium tracking-wider uppercase hover:bg-monroe-accent/90 transition-colors duration-300"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
